...
namespace MvcProjectArch.Core.Infrastructure.DependencyManagement
{
   public class ContainerManager
    {
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new ProjectNameException("Unkown dependency");
            ...
            throw new ProjectNameException("No contructor was found that had all the dependencies satisfied.");
        }
